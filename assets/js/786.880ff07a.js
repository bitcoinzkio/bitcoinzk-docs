...
/* harmony import */ var _createText_d213de94_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86746);
...
class TextDimensionCalculatorWithFont {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_createText_d213de94_js__WEBPACK_IMPORTED_MODULE_1__.c)(elem, 1, t);
...
class BandAxis extends BaseAxis {
  ...
  recalculateScale() {
    ...
    _mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.l.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
function getChartDefaultThemeConfig() {
  ...
  const config = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.F)();
  return (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.C)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
function getChartDefaultConfig() {
  const config = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.F)();
  return (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.C)(
    _mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.B.xyChart,
    config.xyChart
  );
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.t)();
...
const draw = (txt, id, _version, diagObj) => {
  ...
  _mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Rendering xychart chart\n" + txt);
  const svg = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.A)(id);
  ...
  (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.i)(svg, chartConfig.height, chartConfig.width, true);
