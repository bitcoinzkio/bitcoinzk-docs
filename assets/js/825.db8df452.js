...
/* harmony import */ var _svgDrawCommon_3ba9043b_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3528);
...
const setC4Type = function(c4TypeParam) {
  let sanitizedText = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.d)(c4TypeParam, (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.c)());
...
const setTitle = function(txt) {
  let sanitizedText = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.d)(txt, (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  title = sanitizedText;
};
const db = {
  addPersonOrSystem,
  ...
  getConfig: () => (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.c)().c4,
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
const drawRect = function(elem, rectData) {
  return (0,_svgDrawCommon_3ba9043b_js__WEBPACK_IMPORTED_MODULE_2__.d)(elem, rectData);
};
...
const drawC4Shape = function(elem, c4Shape, conf2) {
  ...
  const rect = (0,_svgDrawCommon_3ba9043b_js__WEBPACK_IMPORTED_MODULE_2__.g)();
  switch (c4Shape.typeC4Shape.text) {
    case "person":
    case "external_person":
    case "system":
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      c4Shape[textType].text = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.w)(c4Shape[textType].text, textLimitWidth, textConf);
      c4Shape[textType].textLines = c4Shape[textType].text.split(_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.e.lineBreakRegex).length;
      c4Shape[textType].width = textLimitWidth;
      c4Shape[textType].height = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.j)(c4Shape[textType].text, textConf);
    } else {
      let lines = c4Shape[textType].text.split(_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.e.lineBreakRegex);
      ...
      for (const line of lines) {
        c4Shape[textType].width = Math.max(
          (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.h)(line, textConf),
          c4Shape[textType].width
        );
        lineHeight = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.j)(line, textConf);
...
const drawBoundary = function(diagram2, boundary, bounds) {
  ...
  let textLimitWidth = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.h)(boundary.label.text, boundaryLabelConf);
...
const drawC4ShapeArray = function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  ...
  for (const c4ShapeKey of c4ShapeKeys) {
    ...
    c4Shape.typeC4Shape.width = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.h)(
...
const drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
  ...
  for (let rel of rels2) {
    ...
    let textLimitWidth = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.h)(rel.label.text, relConf);
    calcC4ShapeTextWH("label", rel, relTextWrap, relConf, textLimitWidth);
    if (rel.techn && rel.techn.text !== "") {
      textLimitWidth = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.h)(rel.techn.text, relConf);
      calcC4ShapeTextWH("techn", rel, relTextWrap, relConf, textLimitWidth);
    }
    if (rel.descr && rel.descr.text !== "") {
      textLimitWidth = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.h)(rel.descr.text, relConf);
...
const draw = function(_text, id, _version, diagObj) {
  conf = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.c)().c4;
  const securityLevel = (0,_mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.c)().securityLevel;
  let sandboxElement;
  ...
  _mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`C:${JSON.stringify(conf, null, 2)}`);
  ...
  _mermaid_ad1dc92f_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`models:`, box);
};
const renderer = {
